...
namespace Tests
{
    ...
    public class MaterialMonitorTests : TestBase
    {
        ...
        public void TestMaterialAmountFromJson()
        {
            ...
            var materialAmount = JsonConvert.DeserializeObject<MaterialAmount>(molybdenumJson);
